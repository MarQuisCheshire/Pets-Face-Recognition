...
dataset = RecDataset(
    Path('../pets_datasets/data_25_transformed_v7_dogs'),
    None,
    2,
...
dataset3 = RecDataset(
    Path('../pets_datasets/petfinder_extra_dogs_transformed_v7'),
    None,
    3,
    init_dataset_method=simple_init_dataset,
...
run_name = 'Updated ResNet50 dataset v7 without jitter'
