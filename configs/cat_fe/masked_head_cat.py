...
dataset = RecDataset(
    Path('../pets_datasets/data_25_transformed_v6_masked_cats'),
    None,
    3,
...
dataset3 = RecDataset(
    Path('../pets_datasets/petfinder_extra_cats_transformed_v6_masked'),
    None,
    3,
    init_dataset_method=simple_init_dataset,
...
def optimizer(model_):
    ...
    optim = torch.optim.SGD(d, 1e-2, momentum=0.9)
