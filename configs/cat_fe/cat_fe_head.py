...
dataset = RecDataset(
    Path('../pets_datasets/data_25_transformed_v6_cats'),
    None,
    3,
...
dataset3 = RecDataset(
    Path('../pets_datasets/petfinder_extra_cats_transformed_v6'),
    None,
    3,
    init_dataset_method=simple_init_dataset,
...
run_name = 'Updated ResNet50 datasetv6 without jitter'
